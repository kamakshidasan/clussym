...
analysis required by an application. {\color{blue}We use the first ten non-zero eigen values
of the Laplace-Beltrami spectra as the shape descriptor}. This descriptor has been used for 
