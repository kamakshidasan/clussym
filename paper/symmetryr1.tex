...
{\color{blue}This approximation assumes that the scalar field is continuously sampled.}
...
\begin{minipage}{\textwidth}
	...
	\subfigure[]
	{
		\includegraphics[scale=0.1]{figures/isabel1-c.png}
		\label{volisa1}
	}
	\subfigure[]
	{
	...
	\subfigure[]
	{
		\includegraphics[scale=0.1]{figures/isabel1-det-c.png}
		\label{detisa1}
	}
\end{minipage}
\begin{minipage}{\textwidth}
