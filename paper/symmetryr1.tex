...
\section{Discussion}
In this section, we discuss the results of our method on different datasets and elaborate on
the selection of parameters, comparison with existing topology based methods, and performance.
...
too small a value for the stabilisation parameter $\alpha$ may result in only partial detection
...
the length of the total range of scalar values. However, only four of the seven symmetric
...
insensitive to the exact value of $\alpha$.
...
We choose a value immediately after this sudden drop and set this as the value of $\delta$. When
