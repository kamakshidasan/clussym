...
%	{
		...
		{
			\centering
			\includegraphics[scale=.3]{figures/1897-full.png}
		}
		\end{minipage}
%	}
	\hspace{0.02cm}
...
%	{
		\begin{minipage}[c][1\width]{0.32\textwidth}
		{
			\centering
			\hspace{0.2cm}
			\includegraphics[scale=.3]{inkscape/descspace.pdf}
		}
		\end{minipage}
%	}	
%	\subfigure[]
%	{
		...
		{
			\centering
			\includegraphics[scale=.3]{figures/1897-sym.png}
		}
		\end{minipage}
%	}
...
Figure~\ref{fuel-full}, this plot is shown in the supplemental material. The plot shows a sudden
...
\acknowledgments{
	This work was partially supported by the Department of Science and Technology, India, under Grant SR/S3/EECE/0086/2012 and by the Robert Bosch Centre for Cyber Physical Systems, Indian Institute of Science. The second author was supported by a fellowship for experienced researchers from the Alexander von Humboldt Foundation. Hurricane Isabel data produced by the Weather Research and Forecast (WRF) model, courtesy of NCAR and the U.S. National Science Foundation
