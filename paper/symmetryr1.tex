...
\teaser{
	...
	which exhibit 3-fold rotational symmetry. (b)~Contours belonging to symmetric regions are also symmetric and these
	contours can be represented as points in a high dimensional descriptor space (shown in 2D for illustration) using
